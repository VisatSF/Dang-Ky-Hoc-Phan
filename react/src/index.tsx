...
const isFirebaseConfigured =
  !!firebaseApiKey &&
  firebaseApiKey !== 'unspecified' &&
  !firebaseApiKey.includes('DOCAbC123dEf456');

const firebaseConfig = {
  apiKey: firebaseApiKey || 'unspecified',
...
if (app) {
  try {
    ...
    // Ignore firebase performance errors when running locally
  }
}
